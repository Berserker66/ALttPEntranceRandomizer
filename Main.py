...
def main(args, seed=None, fish=None):
    ...
    for player in range(1, world.players+1):
        ...
        if "-" in world.doorShuffle[player]:
            ...
            if seed.startswith("team-"):
                world.dr_seeds[player] = get_same_seed(world, (shuffle, seed, world.shuffle[player], world.er_seeds[player], world.mode[player], world.intensity[player], world.potshuffle[player], world.keydropshuffle[player]))
            else:
    ...
    def _gen_rom(team: int, player: int):
        ...
        patch_rom(world, rom, player, team, use_enemizer, bool(args.outputname))
...
def copy_world(world):
    ...
    ret = World(world.players, world.shuffle, world.doorShuffle, world.logic, world.mode, world.swords,
                world.difficulty, world.item_functionality, world.timer, world.progressive, world.goal, world.algorithm,

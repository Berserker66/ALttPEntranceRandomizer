...
item_table = {'Bow': (True, None, 0x0B, 'You have\nchosen the\narcher class.', 'the stick and twine', 'arrow-slinging kid', 'arrow sling for sale', 'witch and robin hood', 'archer boy shoots again', 'the Bow'),
              ...
              'Trench 1 Filled': (True, 'Event', None, None, None, None, None, None, None, None),
              'Trench 2 Filled': (True, 'Event', None, None, None, None, None, None, None, None),
              'Drained Swamp': (True, 'Event', None, None, None, None, None, None, None, None),
              'Shining Light': (True, 'Event', None, None, None, None, None, None, None, None),
              'Maiden Rescued': (True, 'Event', None, None, None, None, None, None, None, None),
              'Maiden Unmasked': (True, 'Event', None, None, None, None, None, None, None, None),
